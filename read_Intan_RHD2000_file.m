...
[file, path, filterindex] = ...
    uigetfile('*.rhd', 'Select an RHD2000 Data File', 'MultiSelect', 'off','C:\Users\');
...
% fprintf(1,Fname,'\n');
% amplifier_data=amplifier_data(1:2,1:4433000);
% t_amplifier=t_amplifier(1,1:4433000);
% board_adc_data=board_adc_data(1,1:4433000);
save([path,Fname,'.mat'],'amplifier_data','t_amplifier','sample_rate','board_adc_data');
h = msgbox('Finish!!');
return
